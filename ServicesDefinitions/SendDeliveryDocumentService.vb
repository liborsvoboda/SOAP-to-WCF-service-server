...
Namespace SendDeliveryDocument

    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),
 System.ServiceModel.ServiceContractAttribute(Name:="SendDeliveryDocumentConsumerService", [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocument/v1")>
    Public Interface ISendDeliveryDocument

        <System.ServiceModel.OperationContract(Action:="sendDeliveryDocument"),', ReplyAction:="*"
        System.ServiceModel.FaultContractAttribute(GetType(schemas.telekom.net.csdg_v01._02.TCTechnicalFaultInfo), Action:="sendDeliveryDocument", Name:="technicalFault", [Namespace]:="http://schemas.telekom.net/csdg_v01.02"),
        System.ServiceModel.XmlSerializerFormatAttribute()>
        Function sendDeliveryDocument(ByVal request As sendDeliveryDocumentRequest) As sendDeliveryDocumentResponse

        '<System.ServiceModel.OperationContractAttribute(Action:="sendDeliveryDocument", ReplyAction:="*")>
        'Function sendDeliveryDocumentAsync(ByVal request As sendDeliveryDocumentRequest) As System.Threading.Tasks.Task(Of sendDeliveryDocumentResponse)
    End Interface
 ...
 System.Xml.Serialization.XmlTypeAttribute([Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07

        Private iDOCField As ZSCMT19C_DELVRY07IDOC

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property IDOC() As ZSCMT19C_DELVRY07IDOC
            Get
                Return Me.iDOCField
            End Get
            Set
 ...
 System.Diagnostics.DebuggerStepThroughAttribute(),
 System.ComponentModel.DesignerCategoryAttribute("code"),
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOC

        Private eDI_DC40Field As ZSCMT19C_DELVRY07IDOCEDI_DC40

        Private e1EDL20Field() As ZSCMT19C_DELVRY07IDOCE1EDL20

        Private e1UPSLINKField As ZSCMT19C_DELVRY07IDOCE1UPSLINK

        Private e1BP_XI_FORCEField() As ZSCMT19C_DELVRY07IDOCE1BP_XI_FORCE

        Private bEGINField As ZSCMT19C_DELVRY07IDOCBEGIN

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property EDI_DC40() As ZSCMT19C_DELVRY07IDOCEDI_DC40
            Get
        ...
        Public Property E1EDL20() As ZSCMT19C_DELVRY07IDOCE1EDL20()
            Get
        ...
        Public Property E1UPSLINK() As ZSCMT19C_DELVRY07IDOCE1UPSLINK
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1BP_XI_FORCE", Order:=3)>
        Public Property E1BP_XI_FORCE() As ZSCMT19C_DELVRY07IDOCE1BP_XI_FORCE()
            Get
                Return Me.e1BP_XI_FORCEField
            End Get
            Set
                Me.e1BP_XI_FORCEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property BEGIN() As ZSCMT19C_DELVRY07IDOCBEGIN
            Get
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCEDI_DC40
        ...
        Private dIRECTField As ZSCMT19C_DELVRY07IDOCEDI_DC40DIRECT
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCEDI_DC40SEGMENT

        Public Sub New()
            MyBase.New
            Me.tABNAMField = "EDI_DC40"
            Me.iDOCTYPField = "DELVRY07"
            Me.cIMTYPField = "ZSCMT19C_DELVRY07"
        End Sub
        ...
        Public Property DIRECT() As ZSCMT19C_DELVRY07IDOCEDI_DC40DIRECT
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCEDI_DC40SEGMENT
            Get
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCEDI_DC40DIRECT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCEDI_DC40SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20
        ...
        Private zSCMT19C_E1EDL20Field() As ZSCMT19C_DELVRY07IDOCE1EDL20ZSCMT19C_E1EDL20

        Private e1EDL20RET2Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL20RET2

        Private e1EDL22Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL22

        Private e1EDL21Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21

        Private e1EDL51Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL51

        Private e1EDD01Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDD01

        Private e1EDL18Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL18

        Private e1EDL55Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL55

        Private e1ADRM1Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1

        Private e1EDT13Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13

        Private e1TXTH8Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8

        Private e1EDDH2Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2

        Private e1EDL33Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33

        Private e1EDL28Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28

        Private e1EDL47Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47

        Private e1EDL24Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24

        Private e1EDL37Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37

        Private e1EDL54Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL54

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20SEGMENT
        ...
        Public Property ZSCMT19C_E1EDL20() As ZSCMT19C_DELVRY07IDOCE1EDL20ZSCMT19C_E1EDL20()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL20RET2", Order:=34)>
        Public Property E1EDL20RET2() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL20RET2()
            Get
                Return Me.e1EDL20RET2Field
            End Get
            Set
                Me.e1EDL20RET2Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=35)>
        Public Property E1EDL22() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL22
            Get
        ...
        Public Property E1EDL21() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL51", Order:=37)>
        Public Property E1EDL51() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL51()
            Get
        ...
        Public Property E1EDD01() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDD01
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL18", Order:=39)>
        Public Property E1EDL18() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL18()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL55", Order:=40)>
        Public Property E1EDL55() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL55()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1ADRM1", Order:=41)>
        Public Property E1ADRM1() As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDT13", Order:=42)>
        Public Property E1EDT13() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1TXTH8", Order:=43)>
        Public Property E1TXTH8() As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDDH2", Order:=44)>
        Public Property E1EDDH2() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2()
            Get
        ...
        Public Property E1EDL33() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33
            Get
        ...
        Public Property E1EDL28() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28
            Get
        ...
        Public Property E1EDL47() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL24", Order:=48)>
        Public Property E1EDL24() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL37", Order:=49)>
        Public Property E1EDL37() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL54", Order:=50)>
        Public Property E1EDL54() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL54()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20ZSCMT19C_E1EDL20
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20ZSCMT19C_E1EDL20SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20ZSCMT19C_E1EDL20SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20ZSCMT19C_E1EDL20SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL20RET2
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL20RET2SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL20RET2SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL20RET2SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL22
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL22SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL22SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL22SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21
        ...
        Private e1EDL23Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21E1EDL23

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=11)>
        Public Property E1EDL23() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21E1EDL23
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21E1EDL23
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21E1EDL23SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21E1EDL23SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21E1EDL23SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL21SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL51

        Private qUALFField As String

        Private pRODNField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL51SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL51SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL51SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDD01
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDD01SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDD01SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDD01SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL18

        Private qUALFField As String

        Private pARAMField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL18SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL18SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL18SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL55

        Private qUALFField As String

        Private rEFNRField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL55SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL55SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL55SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1
        ...
        Private e1ADRE1Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1E1ADRE1

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1SEGMENT
        ...
        Public Property E1ADRE1() As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1E1ADRE1()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1E1ADRE1

        Private eXTEND_QField As String

        Private eXTEND_DField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1E1ADRE1SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1E1ADRE1SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1E1ADRE1SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1ADRM1SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13
        ...
        Private e1EDL40Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40

        Private e1TXTH0Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=18)>
        Public Property E1EDL40() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40
            Get
        ...
        Public Property E1TXTH0() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40

        Private kNOTEField As String

        Private kNOTE_BEZField As String

        Private e1ADRM2Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40E1ADRM2

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property E1ADRM2() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40E1ADRM2
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40E1ADRM2
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40E1ADRM2SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40E1ADRM2SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40E1ADRM2SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1EDL40SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0
        ...
        Private e1TXTP0Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0E1TXTP0

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0SEGMENT
        ...
        Public Property E1TXTP0() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0E1TXTP0()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0E1TXTP0

        Private tDFORMATField As String

        Private tDLINEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0E1TXTP0SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0E1TXTP0SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0E1TXTP0SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13E1TXTH0SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDT13SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8
        ...
        Private e1TXTP8Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8E1TXTP8

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8SEGMENT
        ...
        Public Property E1TXTP8() As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8E1TXTP8()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8E1TXTP8

        Private tDFORMATField As String

        Private tDLINEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8E1TXTP8SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8E1TXTP8SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8E1TXTP8SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1TXTH8SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2
        ...
        Private e1EDDP2Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2E1EDDP2

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2SEGMENT
        ...
        Public Property E1EDDP2() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2E1EDDP2()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2E1EDDP2

        Private tDFORMATField As String

        Private tDLINEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2E1EDDP2SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2E1EDDP2SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2E1EDDP2SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDDH2SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33
        ...
        Private e1EDL34Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33E1EDL34

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=19)>
        Public Property E1EDL34() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33E1EDL34
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33E1EDL34
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33E1EDL34SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33E1EDL34SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33E1EDL34SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL33SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28
        ...
        Private e1EDL29Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL29

        Private e1EDL30Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property E1EDL29() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL29
            Get
        ...
        Public Property E1EDL30() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL29
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL29SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL29SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL29SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30
        ...
        Private e1EDL31Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL31

        Private e1EDL32Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property E1EDL31() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL31
            Get
        ...
        Public Property E1EDL32() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL31

        Private vSART_BEZField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL31SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL31SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL31SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32
        ...
        Private e1EDL45Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1EDL45

        Private e1ADRM3Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1ADRM3

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=12)>
        Public Property E1EDL45() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1EDL45
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=13)>
        Public Property E1ADRM3() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1ADRM3
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1EDL45
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1EDL45SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1EDL45SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1EDL45SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1ADRM3
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1ADRM3SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1ADRM3SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32E1ADRM3SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30E1EDL32SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28E1EDL30SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL28SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47
        ...
        Private e1EDL48Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47E1EDL48

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47SEGMENT
        ...
        Public Property E1EDL48() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47E1EDL48()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47E1EDL48
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47E1EDL48SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47E1EDL48SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47E1EDL48SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL47SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24
        ...
        Private zSCMT19C_E1EDL24Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZSCMT19C_E1EDL24

        Private zE1EDL98Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZE1EDL98

        Private e1EDL56Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL56

        Private e1EDL24RET2Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL24RET2

        Private e1EDL25Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL25

        Private e1EDL26Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26

        Private e1EDL52Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL52

        Private e1EDL53Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL53

        Private e1EDD10Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10

        Private e1EDD14Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD14

        Private e1EDL19Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL19

        Private e1EDL11Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL11

        Private e1EPC01Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01

        Private e1EDL15Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL15

        Private e1EDL35Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35

        Private e1EDL43Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL43

        Private e1EDL41Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41

        Private e1TXTH9Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9

        Private e1EDL12Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL12

        Private e1EDL58Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24SEGMENT
        ...
        Public Property ZSCMT19C_E1EDL24() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZSCMT19C_E1EDL24()
            Get
        ...
        Public Property ZE1EDL98() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZE1EDL98
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL56", Order:=74)>
        Public Property E1EDL56() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL56()
            Get
                Return Me.e1EDL56Field
            End Get
            Set
                Me.e1EDL56Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL24RET2", Order:=75)>
        Public Property E1EDL24RET2() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL24RET2()
            Get
                Return Me.e1EDL24RET2Field
            End Get
            Set
                Me.e1EDL24RET2Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=76)>
        Public Property E1EDL25() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL25
            Get
        ...
        Public Property E1EDL26() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL52", Order:=78)>
        Public Property E1EDL52() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL52()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL53", Order:=79)>
        Public Property E1EDL53() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL53()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD10", Order:=80)>
        Public Property E1EDD10() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10()
            Get
        ...
        Public Property E1EDD14() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD14
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL19", Order:=82)>
        Public Property E1EDL19() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL19()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL11", Order:=83)>
        Public Property E1EDL11() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL11()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EPC01", Order:=84)>
        Public Property E1EPC01() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01()
            Get
                Return Me.e1EPC01Field
            End Get
            Set
                Me.e1EPC01Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL15", Order:=85)>
        Public Property E1EDL15() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL15()
            Get
        ...
        Public Property E1EDL35() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL43", Order:=87)>
        Public Property E1EDL43() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL43()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL41", Order:=88)>
        Public Property E1EDL41() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1TXTH9", Order:=89)>
        Public Property E1TXTH9() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL12", Order:=90)>
        Public Property E1EDL12() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL12()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL58", Order:=91)>
        Public Property E1EDL58() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58()
            Get
                Return Me.e1EDL58Field
            End Get
            Set
                Me.e1EDL58Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZSCMT19C_E1EDL24
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZSCMT19C_E1EDL24SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZSCMT19C_E1EDL24SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZSCMT19C_E1EDL24SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZE1EDL98
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZE1EDL98SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZE1EDL98SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24ZE1EDL98SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL56

        Private cARRIER_IDField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL56SEGMENT

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property CARRIER_ID() As String
            Get
                Return Me.cARRIER_IDField
            End Get
            Set
                Me.cARRIER_IDField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL56SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL56SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL24RET2
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL24RET2SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL24RET2SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL24RET2SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL25
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL25SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL25SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL25SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26
        ...
        Private e1EDL27Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26E1EDL27

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=37)>
        Public Property E1EDL27() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26E1EDL27
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26E1EDL27
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26E1EDL27SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26E1EDL27SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26E1EDL27SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL26SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL52
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL52SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL52SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL52SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL53
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL53SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL53SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL53SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10
        ...
        Private e1EDD11Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD11

        Private e1EDD15Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD15

        Private e1EDD12Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12

        Private e1EDD13Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD13

        Private e1EDDH3Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3

        Private e1EDD17Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD17

        Private e1EDD18Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD18

        Private e1EDD19Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD19

        Private e1EDD20Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD20

        Private e1EDDH4Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10SEGMENT
        ...
        Public Property E1EDD11() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD11
            Get
        ...
        Public Property E1EDD15() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD15
            Get
        ...
        Public Property E1EDD12() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12()
            Get
        ...
        Public Property E1EDD13() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD13()
            Get
        ...
        Public Property E1EDDH3() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3()
            Get
        ...
        Public Property E1EDD17() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD17
            Get
                Return Me.e1EDD17Field
            End Get
            Set
                Me.e1EDD17Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=135)>
        Public Property E1EDD18() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD18
            Get
                Return Me.e1EDD18Field
            End Get
            Set
                Me.e1EDD18Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD19", Order:=136)>
        Public Property E1EDD19() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD19()
            Get
                Return Me.e1EDD19Field
            End Get
            Set
                Me.e1EDD19Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD20", Order:=137)>
        Public Property E1EDD20() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD20()
            Get
                Return Me.e1EDD20Field
            End Get
            Set
                Me.e1EDD20Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDDH4", Order:=138)>
        Public Property E1EDDH4() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4()
            Get
                Return Me.e1EDDH4Field
            End Get
            Set
                Me.e1EDDH4Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD11
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD11SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD11SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD11SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD15
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD15SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD15SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD15SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12
        ...
        Private e1EDD16Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12E1EDD16

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=89)>
        Public Property E1EDD16() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12E1EDD16
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12E1EDD16
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12E1EDD16SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12E1EDD16SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12E1EDD16SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD12SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD13
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD13SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD13SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD13SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3
        ...
        Private e1EDDP3Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3E1EDDP3

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3SEGMENT
        ...
        Public Property E1EDDP3() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3E1EDDP3()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3E1EDDP3

        Private tDFORMATField As String

        Private tDLINEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3E1EDDP3SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3E1EDDP3SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3E1EDDP3SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH3SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD17

        Private pACKAGE_MATNRField As String

        Private pRIO_ALTERNField As String

        Private fLG_RELEASEDField As String

        Private fLG_TRANS_PERMField As String

        Private fLG_NO_DGField As String

        Private fLG_LQField As String

        Private fLG_RQField As String

        Private iNSTR_ENCLField As String

        Private fLG_SINGLE_PACKField As String

        Private pACODField As String

        Private qUANT_OUT_PACKField As String

        Private u_QUANT_OUT_PACKField As String

        Private rECN_SUBField As String

        Private rECN_CLASSField As String

        Private fLG_CCField As String

        Private fLG_PACKEDField As String

        Private tRANSPORT_TYPEField As String

        Private aPPROVAL_CODEField As String

        Private fLG_EQField As String

        Private dGREL_TRANSIND01Field As String

        Private dGREL_TRANSIND02Field As String

        Private dGREL_TRANSIND03Field As String

        Private dGREL_TRANSIND04Field As String

        Private dGREL_TRANSIND05Field As String

        Private dGREL_TRANSIND06Field As String

        Private dGREL_TRANSIND07Field As String

        Private dGREL_TRANSIND08Field As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD17SEGMENT

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property PACKAGE_MATNR() As String
            Get
                Return Me.pACKAGE_MATNRField
            End Get
            Set
                Me.pACKAGE_MATNRField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
        Public Property PRIO_ALTERN() As String
            Get
                Return Me.pRIO_ALTERNField
            End Get
            Set
                Me.pRIO_ALTERNField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property FLG_RELEASED() As String
            Get
                Return Me.fLG_RELEASEDField
            End Get
            Set
                Me.fLG_RELEASEDField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public Property FLG_TRANS_PERM() As String
            Get
                Return Me.fLG_TRANS_PERMField
            End Get
            Set
                Me.fLG_TRANS_PERMField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=4)>
        Public Property FLG_NO_DG() As String
            Get
                Return Me.fLG_NO_DGField
            End Get
            Set
                Me.fLG_NO_DGField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=5)>
        Public Property FLG_LQ() As String
            Get
                Return Me.fLG_LQField
            End Get
            Set
                Me.fLG_LQField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property FLG_RQ() As String
            Get
                Return Me.fLG_RQField
            End Get
            Set
                Me.fLG_RQField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property INSTR_ENCL() As String
            Get
                Return Me.iNSTR_ENCLField
            End Get
            Set
                Me.iNSTR_ENCLField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=8)>
        Public Property FLG_SINGLE_PACK() As String
            Get
                Return Me.fLG_SINGLE_PACKField
            End Get
            Set
                Me.fLG_SINGLE_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=9)>
        Public Property PACOD() As String
            Get
                Return Me.pACODField
            End Get
            Set
                Me.pACODField = Value
            End Set
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=10)>
        Public Property QUANT_OUT_PACK() As String
            Get
                Return Me.qUANT_OUT_PACKField
            End Get
            Set
                Me.qUANT_OUT_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=11)>
        Public Property U_QUANT_OUT_PACK() As String
            Get
                Return Me.u_QUANT_OUT_PACKField
            End Get
            Set
                Me.u_QUANT_OUT_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=12)>
        Public Property RECN_SUB() As String
            Get
                Return Me.rECN_SUBField
            End Get
            Set
                Me.rECN_SUBField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=13)>
        Public Property RECN_CLASS() As String
            Get
                Return Me.rECN_CLASSField
            End Get
            Set
                Me.rECN_CLASSField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=14)>
        Public Property FLG_CC() As String
            Get
                Return Me.fLG_CCField
            End Get
            Set
                Me.fLG_CCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=15)>
        Public Property FLG_PACKED() As String
            Get
                Return Me.fLG_PACKEDField
            End Get
            Set
                Me.fLG_PACKEDField = Value
            End Set
        End Property
        ...
        Public Property APPROVAL_CODE() As String
            Get
                Return Me.aPPROVAL_CODEField
            End Get
            Set
                Me.aPPROVAL_CODEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=18)>
        Public Property FLG_EQ() As String
            Get
                Return Me.fLG_EQField
            End Get
            Set
                Me.fLG_EQField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=19)>
        Public Property DGREL_TRANSIND01() As String
            Get
                Return Me.dGREL_TRANSIND01Field
            End Get
            Set
                Me.dGREL_TRANSIND01Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=20)>
        Public Property DGREL_TRANSIND02() As String
            Get
                Return Me.dGREL_TRANSIND02Field
            End Get
            Set
                Me.dGREL_TRANSIND02Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=21)>
        Public Property DGREL_TRANSIND03() As String
            Get
                Return Me.dGREL_TRANSIND03Field
            End Get
            Set
                Me.dGREL_TRANSIND03Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=22)>
        Public Property DGREL_TRANSIND04() As String
            Get
                Return Me.dGREL_TRANSIND04Field
            End Get
            Set
                Me.dGREL_TRANSIND04Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=23)>
        Public Property DGREL_TRANSIND05() As String
            Get
                Return Me.dGREL_TRANSIND05Field
            End Get
            Set
                Me.dGREL_TRANSIND05Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=24)>
        Public Property DGREL_TRANSIND06() As String
            Get
                Return Me.dGREL_TRANSIND06Field
            End Get
            Set
                Me.dGREL_TRANSIND06Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=25)>
        Public Property DGREL_TRANSIND07() As String
            Get
                Return Me.dGREL_TRANSIND07Field
            End Get
            Set
                Me.dGREL_TRANSIND07Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=26)>
        Public Property DGREL_TRANSIND08() As String
            Get
                Return Me.dGREL_TRANSIND08Field
            End Get
            Set
                Me.dGREL_TRANSIND08Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD17SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD17SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD18

        Private tRANSP_TYPEField As String

        Private tRANSP_APPROVEDField As String

        Private lEG_SRC_RESTRField As String

        Private mIN_QUANTField As String

        Private u_MIN_QUANTField As String

        Private fLG_MIN_QUANTField As String

        Private mAX_QUANTField As String

        Private u_MAX_QUANTField As String

        Private fLG_MAX_QUANTField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD18SEGMENT

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property TRANSP_TYPE() As String
            Get
                Return Me.tRANSP_TYPEField
            End Get
            Set
                Me.tRANSP_TYPEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
        Public Property TRANSP_APPROVED() As String
            Get
                Return Me.tRANSP_APPROVEDField
            End Get
            Set
                Me.tRANSP_APPROVEDField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property LEG_SRC_RESTR() As String
            Get
                Return Me.lEG_SRC_RESTRField
            End Get
            Set
                Me.lEG_SRC_RESTRField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public Property MIN_QUANT() As String
            Get
                Return Me.mIN_QUANTField
            End Get
            Set
                Me.mIN_QUANTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=4)>
        Public Property U_MIN_QUANT() As String
            Get
                Return Me.u_MIN_QUANTField
            End Get
            Set
                Me.u_MIN_QUANTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=5)>
        Public Property FLG_MIN_QUANT() As String
            Get
                Return Me.fLG_MIN_QUANTField
            End Get
            Set
                Me.fLG_MIN_QUANTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property MAX_QUANT() As String
            Get
                Return Me.mAX_QUANTField
            End Get
            Set
                Me.mAX_QUANTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property U_MAX_QUANT() As String
            Get
                Return Me.u_MAX_QUANTField
            End Get
            Set
                Me.u_MAX_QUANTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=8)>
        Public Property FLG_MAX_QUANT() As String
            Get
                Return Me.fLG_MAX_QUANTField
            End Get
            Set
                Me.fLG_MAX_QUANTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD18SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD18SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD19

        Private aBS_ACTField As String

        Private aBS_ACT_UField As String

        Private rEL_SPEC_ACTField As String

        Private rEL_SPEC_ACT_UField As String

        Private cONTAMINATIONField As String

        Private cONTAMINATION_UField As String

        Private dOSE_RATEField As String

        Private dOSE_RATE_UField As String

        Private mAX_ACT1Field As String

        Private mAX_ACT1_UField As String

        Private aCT1_UNLIMITField As String

        Private mAX_ACT2Field As String

        Private mAX_ACT2_UField As String

        Private aCT2_UNLIMITField As String

        Private aCT_SUB_PACKField As String

        Private aCT_SUB_PACK_UField As String

        Private mAX_ACT_CONSGField As String

        Private mAX_ACT_CONSG_UField As String

        Private mULT_ACT_SGLField As String

        Private rEF_ACT_SGLField As String

        Private mULT_ACT_PACKField As String

        Private rEF_ACT_PACKField As String

        Private mAX_CONT_AField As String

        Private mAX_CONT_A_UField As String

        Private mAX_CONT_B_GField As String

        Private mAX_CONT_B_G_UField As String

        Private mAX_DOSE_UNPField As String

        Private mAX_DOSE_UNP_UField As String

        Private dIST_DOSE_UNPField As String

        Private dIST_DOSE_UNP_UField As String

        Private nO_DIST_UNPField As String

        Private mAX_DOSE_PACKField As String

        Private mAX_DOSE_PACK_UField As String

        Private dIST_DOSE_PACKField As String

        Private dIST_DOSE_PACK_UField As String

        Private nO_DIST_PACKField As String

        Private mAX_ACT_SGL_DCField As String

        Private mAX_ACT_SGL_U_DCField As String

        Private aCT_SGL_UNLIM_DCField As String

        Private mAX_ACT_PAC_DCField As String

        Private mAX_ACT_PAC_U_DCField As String

        Private aCT_PAC_UNLIM_DCField As String

        Private eXCPT_PAC_OPT_DCField As String

        Private mAX_GRS_WGHT_DCField As String

        Private u_MAX_GRS_WGT_DCField As String

        Private aCT_EMIS_TYPEField As String

        Private mAX_NEM_DCField As String

        Private mAX_NEM_U_DCField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD19SEGMENT

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property ABS_ACT() As String
            Get
                Return Me.aBS_ACTField
            End Get
            Set
                Me.aBS_ACTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
        Public Property ABS_ACT_U() As String
            Get
                Return Me.aBS_ACT_UField
            End Get
            Set
                Me.aBS_ACT_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property REL_SPEC_ACT() As String
            Get
                Return Me.rEL_SPEC_ACTField
            End Get
            Set
                Me.rEL_SPEC_ACTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public Property REL_SPEC_ACT_U() As String
            Get
                Return Me.rEL_SPEC_ACT_UField
            End Get
            Set
                Me.rEL_SPEC_ACT_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=4)>
        Public Property CONTAMINATION() As String
            Get
                Return Me.cONTAMINATIONField
            End Get
            Set
                Me.cONTAMINATIONField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=5)>
        Public Property CONTAMINATION_U() As String
            Get
                Return Me.cONTAMINATION_UField
            End Get
            Set
                Me.cONTAMINATION_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property DOSE_RATE() As String
            Get
                Return Me.dOSE_RATEField
            End Get
            Set
                Me.dOSE_RATEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property DOSE_RATE_U() As String
            Get
                Return Me.dOSE_RATE_UField
            End Get
            Set
                Me.dOSE_RATE_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=8)>
        Public Property MAX_ACT1() As String
            Get
                Return Me.mAX_ACT1Field
            End Get
            Set
                Me.mAX_ACT1Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=9)>
        Public Property MAX_ACT1_U() As String
            Get
                Return Me.mAX_ACT1_UField
            End Get
            Set
                Me.mAX_ACT1_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=10)>
        Public Property ACT1_UNLIMIT() As String
            Get
                Return Me.aCT1_UNLIMITField
            End Get
            Set
                Me.aCT1_UNLIMITField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=11)>
        Public Property MAX_ACT2() As String
            Get
                Return Me.mAX_ACT2Field
            End Get
            Set
                Me.mAX_ACT2Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=12)>
        Public Property MAX_ACT2_U() As String
            Get
                Return Me.mAX_ACT2_UField
            End Get
            Set
                Me.mAX_ACT2_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=13)>
        Public Property ACT2_UNLIMIT() As String
            Get
                Return Me.aCT2_UNLIMITField
            End Get
            Set
                Me.aCT2_UNLIMITField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=14)>
        Public Property ACT_SUB_PACK() As String
            Get
                Return Me.aCT_SUB_PACKField
            End Get
            Set
                Me.aCT_SUB_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=15)>
        Public Property ACT_SUB_PACK_U() As String
            Get
                Return Me.aCT_SUB_PACK_UField
            End Get
            Set
                Me.aCT_SUB_PACK_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=16)>
        Public Property MAX_ACT_CONSG() As String
            Get
                Return Me.mAX_ACT_CONSGField
            End Get
            Set
                Me.mAX_ACT_CONSGField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=17)>
        Public Property MAX_ACT_CONSG_U() As String
            Get
                Return Me.mAX_ACT_CONSG_UField
            End Get
            Set
                Me.mAX_ACT_CONSG_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=18)>
        Public Property MULT_ACT_SGL() As String
            Get
                Return Me.mULT_ACT_SGLField
            End Get
            Set
                Me.mULT_ACT_SGLField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=19)>
        Public Property REF_ACT_SGL() As String
            Get
                Return Me.rEF_ACT_SGLField
            End Get
            Set
                Me.rEF_ACT_SGLField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=20)>
        Public Property MULT_ACT_PACK() As String
            Get
                Return Me.mULT_ACT_PACKField
            End Get
            Set
                Me.mULT_ACT_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=21)>
        Public Property REF_ACT_PACK() As String
            Get
                Return Me.rEF_ACT_PACKField
            End Get
            Set
                Me.rEF_ACT_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=22)>
        Public Property MAX_CONT_A() As String
            Get
                Return Me.mAX_CONT_AField
            End Get
            Set
                Me.mAX_CONT_AField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=23)>
        Public Property MAX_CONT_A_U() As String
            Get
                Return Me.mAX_CONT_A_UField
            End Get
            Set
                Me.mAX_CONT_A_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=24)>
        Public Property MAX_CONT_B_G() As String
            Get
                Return Me.mAX_CONT_B_GField
            End Get
            Set
                Me.mAX_CONT_B_GField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=25)>
        Public Property MAX_CONT_B_G_U() As String
            Get
                Return Me.mAX_CONT_B_G_UField
            End Get
            Set
                Me.mAX_CONT_B_G_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=26)>
        Public Property MAX_DOSE_UNP() As String
            Get
                Return Me.mAX_DOSE_UNPField
            End Get
            Set
                Me.mAX_DOSE_UNPField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=27)>
        Public Property MAX_DOSE_UNP_U() As String
            Get
                Return Me.mAX_DOSE_UNP_UField
            End Get
            Set
                Me.mAX_DOSE_UNP_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=28)>
        Public Property DIST_DOSE_UNP() As String
            Get
                Return Me.dIST_DOSE_UNPField
            End Get
            Set
                Me.dIST_DOSE_UNPField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=29)>
        Public Property DIST_DOSE_UNP_U() As String
            Get
                Return Me.dIST_DOSE_UNP_UField
            End Get
            Set
                Me.dIST_DOSE_UNP_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=30)>
        Public Property NO_DIST_UNP() As String
            Get
                Return Me.nO_DIST_UNPField
            End Get
            Set
                Me.nO_DIST_UNPField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=31)>
        Public Property MAX_DOSE_PACK() As String
            Get
                Return Me.mAX_DOSE_PACKField
            End Get
            Set
                Me.mAX_DOSE_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=32)>
        Public Property MAX_DOSE_PACK_U() As String
            Get
                Return Me.mAX_DOSE_PACK_UField
            End Get
            Set
                Me.mAX_DOSE_PACK_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=33)>
        Public Property DIST_DOSE_PACK() As String
            Get
                Return Me.dIST_DOSE_PACKField
            End Get
            Set
                Me.dIST_DOSE_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=34)>
        Public Property DIST_DOSE_PACK_U() As String
            Get
                Return Me.dIST_DOSE_PACK_UField
            End Get
            Set
                Me.dIST_DOSE_PACK_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=35)>
        Public Property NO_DIST_PACK() As String
            Get
                Return Me.nO_DIST_PACKField
            End Get
            Set
                Me.nO_DIST_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=36)>
        Public Property MAX_ACT_SGL_DC() As String
            Get
                Return Me.mAX_ACT_SGL_DCField
            End Get
            Set
                Me.mAX_ACT_SGL_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=37)>
        Public Property MAX_ACT_SGL_U_DC() As String
            Get
                Return Me.mAX_ACT_SGL_U_DCField
            End Get
            Set
                Me.mAX_ACT_SGL_U_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=38)>
        Public Property ACT_SGL_UNLIM_DC() As String
            Get
                Return Me.aCT_SGL_UNLIM_DCField
            End Get
            Set
                Me.aCT_SGL_UNLIM_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=39)>
        Public Property MAX_ACT_PAC_DC() As String
            Get
                Return Me.mAX_ACT_PAC_DCField
            End Get
            Set
                Me.mAX_ACT_PAC_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=40)>
        Public Property MAX_ACT_PAC_U_DC() As String
            Get
                Return Me.mAX_ACT_PAC_U_DCField
            End Get
            Set
                Me.mAX_ACT_PAC_U_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=41)>
        Public Property ACT_PAC_UNLIM_DC() As String
            Get
                Return Me.aCT_PAC_UNLIM_DCField
            End Get
            Set
                Me.aCT_PAC_UNLIM_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=42)>
        Public Property EXCPT_PAC_OPT_DC() As String
            Get
                Return Me.eXCPT_PAC_OPT_DCField
            End Get
            Set
                Me.eXCPT_PAC_OPT_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=43)>
        Public Property MAX_GRS_WGHT_DC() As String
            Get
                Return Me.mAX_GRS_WGHT_DCField
            End Get
            Set
                Me.mAX_GRS_WGHT_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=44)>
        Public Property U_MAX_GRS_WGT_DC() As String
            Get
                Return Me.u_MAX_GRS_WGT_DCField
            End Get
            Set
                Me.u_MAX_GRS_WGT_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=45)>
        Public Property ACT_EMIS_TYPE() As String
            Get
                Return Me.aCT_EMIS_TYPEField
            End Get
            Set
                Me.aCT_EMIS_TYPEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=46)>
        Public Property MAX_NEM_DC() As String
            Get
                Return Me.mAX_NEM_DCField
            End Get
            Set
                Me.mAX_NEM_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=47)>
        Public Property MAX_NEM_U_DC() As String
            Get
                Return Me.mAX_NEM_U_DCField
            End Get
            Set
                Me.mAX_NEM_U_DCField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD19SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD19SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD20

        Private eXCEPTIDField As String

        Private vERSIONField As String

        Private bLOCKEDFLGField As String

        Private fIELDNAMEField As String

        Private eXCEPT_VALFRField As String

        Private eXCEPT_VALTOField As String

        Private eNTPR_SPECFLGField As String

        Private cNTRY_SPECFLGField As String

        Private hEADER_TEXTField As String

        Private pOS_TEXTField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD20SEGMENT

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property EXCEPTID() As String
            Get
                Return Me.eXCEPTIDField
            End Get
            Set
                Me.eXCEPTIDField = Value
            End Set
        End Property
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property BLOCKEDFLG() As String
            Get
                Return Me.bLOCKEDFLGField
            End Get
            Set
                Me.bLOCKEDFLGField = Value
            End Set
        End Property
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=4)>
        Public Property EXCEPT_VALFR() As String
            Get
                Return Me.eXCEPT_VALFRField
            End Get
            Set
                Me.eXCEPT_VALFRField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=5)>
        Public Property EXCEPT_VALTO() As String
            Get
                Return Me.eXCEPT_VALTOField
            End Get
            Set
                Me.eXCEPT_VALTOField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property ENTPR_SPECFLG() As String
            Get
                Return Me.eNTPR_SPECFLGField
            End Get
            Set
                Me.eNTPR_SPECFLGField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property CNTRY_SPECFLG() As String
            Get
                Return Me.cNTRY_SPECFLGField
            End Get
            Set
                Me.cNTRY_SPECFLGField = Value
            End Set
        End Property
        ...
        Public Property HEADER_TEXT() As String
            Get
                Return Me.hEADER_TEXTField
            End Get
            Set
                Me.hEADER_TEXTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=9)>
        Public Property POS_TEXT() As String
            Get
                Return Me.pOS_TEXTField
            End Get
            Set
                Me.pOS_TEXTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD20SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDD20SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4
        ...
        Private e1EDDP4Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4E1EDDP4

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDDP4", Order:=10)>
        Public Property E1EDDP4() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4E1EDDP4()
            Get
                Return Me.e1EDDP4Field
            End Get
            Set
                Me.e1EDDP4Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4E1EDDP4

        Private tDFORMATField As String

        Private tDLINEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4E1EDDP4SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4E1EDDP4SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4E1EDDP4SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10E1EDDH4SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD10SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD14
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD14SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD14SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDD14SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL19

        Private qUALFField As String

        Private pARAMField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL19SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL19SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL19SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL11

        Private sERNRField As String

        Private uIIField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL11SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL11SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL11SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01

        Private ePCField As String

        Private uRNField As String

        Private nAMEField As String

        Private pARENT_NAMEField As String

        Private e1IDC01Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01E1IDC01

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1IDC01", Order:=4)>
        Public Property E1IDC01() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01E1IDC01()
            Get
                Return Me.e1IDC01Field
            End Get
            Set
                Me.e1IDC01Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01E1IDC01

        Private qUALFField As String

        Private eLEMENTField As String

        Private eLEMENT_VALUEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01E1IDC01SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property ELEMENT_VALUE() As String
            Get
                Return Me.eLEMENT_VALUEField
            End Get
            Set
                Me.eLEMENT_VALUEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01E1IDC01SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01E1IDC01SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EPC01SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL15
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL15SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL15SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL15SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35
        ...
        Private e1EDL36Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35E1EDL36

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property E1EDL36() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35E1EDL36
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35E1EDL36
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35E1EDL36SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35E1EDL36SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35E1EDL36SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL35SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL43
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL43SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL43SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL43SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41
        ...
        Private e1EDL42Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41E1EDL42

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property E1EDL42() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41E1EDL42
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41E1EDL42

        Private bSARK_BEZField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41E1EDL42SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41E1EDL42SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41E1EDL42SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL41SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9
        ...
        Private e1TXTP9Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9E1TXTP9

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9SEGMENT
        ...
        Public Property E1TXTP9() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9E1TXTP9()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9E1TXTP9

        Private tDFORMATField As String

        Private tDLINEField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9E1TXTP9SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9E1TXTP9SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9E1TXTP9SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1TXTH9SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL12
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL12SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL12SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL12SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58

        Private kDMATField As String

        Private cHARG_KUField As String

        Private eRFMGField As String

        Private eRFMEField As String

        Private e1EDL59Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58E1EDL59

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
        Public Property CHARG_KU() As String
            Get
                Return Me.cHARG_KUField
            End Get
            Set
                Me.cHARG_KUField = Value
            End Set
        End Property
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL59", Order:=4)>
        Public Property E1EDL59() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58E1EDL59()
            Get
                Return Me.e1EDL59Field
            End Get
            Set
                Me.e1EDL59Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58E1EDL59

        Private sERNRField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58E1EDL59SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58E1EDL59SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58E1EDL59SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24E1EDL58SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL24SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37
        ...
        Private e1EDL39Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL39

        Private e1EDL38Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL38

        Private e1EPC02Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02

        Private e1EPC04Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04

        Private e1EDL49Field As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49

        Private e1EDD50Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50

        Private e1EDD52Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52

        Private e1EDL44Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37SEGMENT
        ...
        Public Property E1EDL39() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL39()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=62)>
        Public Property E1EDL38() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL38
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=63)>
        Public Property E1EPC02() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02
            Get
                Return Me.e1EPC02Field
            End Get
            Set
                Me.e1EPC02Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EPC04", Order:=64)>
        Public Property E1EPC04() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04()
            Get
                Return Me.e1EPC04Field
            End Get
            Set
                Me.e1EPC04Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=65)>
        Public Property E1EDL49() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD50", Order:=66)>
        Public Property E1EDD50() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50()
            Get
                Return Me.e1EDD50Field
            End Get
            Set
                Me.e1EDD50Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD52", Order:=67)>
        Public Property E1EDD52() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52()
            Get
                Return Me.e1EDD52Field
            End Get
            Set
                Me.e1EDD52Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL44", Order:=68)>
        Public Property E1EDL44() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL39

        Private qUALFField As String

        Private pARAMField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL39SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL39SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL39SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL38
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL38SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL38SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL38SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02
        ...
        Private e1IDC02Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02E1IDC02

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1IDC02", Order:=4)>
        Public Property E1IDC02() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02E1IDC02()
            Get
                Return Me.e1IDC02Field
            End Get
            Set
                Me.e1IDC02Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02E1IDC02
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02E1IDC02SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02E1IDC02SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02E1IDC02SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC02SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04
        ...
        Private e1IDC04Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04E1IDC04

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1IDC04", Order:=4)>
        Public Property E1IDC04() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04E1IDC04()
            Get
                Return Me.e1IDC04Field
            End Get
            Set
                Me.e1IDC04Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04E1IDC04
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04E1IDC04SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04E1IDC04SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04E1IDC04SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EPC04SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49
        ...
        Private e1EDL50Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49E1EDL50

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49SEGMENT
        ...
        Public Property E1EDL50() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49E1EDL50()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49E1EDL50
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49E1EDL50SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49E1EDL50SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49E1EDL50SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL49SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50
        ...
        Private fLG_DG_PACKAGEField As String

        Private dG_PACKAGE_LEVELField As String

        Private pACKCODEField As String

        Private iNSTR_ENCL_CATField As String

        Private mAT_DAMAGED_CL7Field As String

        Private dOSE_RATE_BULKField As String

        Private dOSE_RATE_BULK_UField As String

        Private dOSE_RATE_PACKField As String

        Private u_DOSE_RATE_PACKField As String

        Private lEADING_LWDGField As String

        Private mAX_GROSS_WEIGHTField As String

        Private u_MAX_GROSS_WGHTField As String

        Private e1EDD51Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50E1EDD51

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public Property FLG_DG_PACKAGE() As String
            Get
                Return Me.fLG_DG_PACKAGEField
            End Get
            Set
                Me.fLG_DG_PACKAGEField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=4)>
        Public Property DG_PACKAGE_LEVEL() As String
            Get
                Return Me.dG_PACKAGE_LEVELField
            End Get
            Set
                Me.dG_PACKAGE_LEVELField = Value
            End Set
        End Property
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=6)>
        Public Property INSTR_ENCL_CAT() As String
            Get
                Return Me.iNSTR_ENCL_CATField
            End Get
            Set
                Me.iNSTR_ENCL_CATField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public Property MAT_DAMAGED_CL7() As String
            Get
                Return Me.mAT_DAMAGED_CL7Field
            End Get
            Set
                Me.mAT_DAMAGED_CL7Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=8)>
        Public Property DOSE_RATE_BULK() As String
            Get
                Return Me.dOSE_RATE_BULKField
            End Get
            Set
                Me.dOSE_RATE_BULKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=9)>
        Public Property DOSE_RATE_BULK_U() As String
            Get
                Return Me.dOSE_RATE_BULK_UField
            End Get
            Set
                Me.dOSE_RATE_BULK_UField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=10)>
        Public Property DOSE_RATE_PACK() As String
            Get
                Return Me.dOSE_RATE_PACKField
            End Get
            Set
                Me.dOSE_RATE_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=11)>
        Public Property U_DOSE_RATE_PACK() As String
            Get
                Return Me.u_DOSE_RATE_PACKField
            End Get
            Set
                Me.u_DOSE_RATE_PACKField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=12)>
        Public Property LEADING_LWDG() As String
            Get
                Return Me.lEADING_LWDGField
            End Get
            Set
                Me.lEADING_LWDGField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=13)>
        Public Property MAX_GROSS_WEIGHT() As String
            Get
                Return Me.mAX_GROSS_WEIGHTField
            End Get
            Set
                Me.mAX_GROSS_WEIGHTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=14)>
        Public Property U_MAX_GROSS_WGHT() As String
            Get
                Return Me.u_MAX_GROSS_WGHTField
            End Get
            Set
                Me.u_MAX_GROSS_WGHTField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD51", Order:=15)>
        Public Property E1EDD51() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50E1EDD51()
            Get
                Return Me.e1EDD51Field
            End Get
            Set
                Me.e1EDD51Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50E1EDD51

        Private lANGUA_ISOField As String

        Private dG_PACKAGE_LEVEL_DField As String

        Private pACKCODE_DField As String

        Private pACKTYPE_DField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50E1EDD51SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
        Public Property DG_PACKAGE_LEVEL_D() As String
            Get
                Return Me.dG_PACKAGE_LEVEL_DField
            End Get
            Set
                Me.dG_PACKAGE_LEVEL_DField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public Property PACKCODE_D() As String
            Get
                Return Me.pACKCODE_DField
            End Get
            Set
                Me.pACKCODE_DField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public Property PACKTYPE_D() As String
            Get
                Return Me.pACKTYPE_DField
            End Get
            Set
                Me.pACKTYPE_DField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50E1EDD51SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50E1EDD51SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD50SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52
        ...
        Private e1EDD53Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52E1EDD53

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD53", Order:=8)>
        Public Property E1EDD53() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52E1EDD53()
            Get
                Return Me.e1EDD53Field
            End Get
            Set
                Me.e1EDD53Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52E1EDD53
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52E1EDD53SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52E1EDD53SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52E1EDD53SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDD52SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44
        ...
        Private e1EDL46Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL46

        Private e1EDL57Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL57

        Private e1EPC03Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03

        Private e1EDD54Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44SEGMENT
        ...
        Public Property E1EDL46() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL46()
            Get
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDL57", Order:=25)>
        Public Property E1EDL57() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL57()
            Get
                Return Me.e1EDL57Field
            End Get
            Set
                Me.e1EDL57Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EPC03", Order:=26)>
        Public Property E1EPC03() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03()
            Get
                Return Me.e1EPC03Field
            End Get
            Set
                Me.e1EPC03Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD54", Order:=27)>
        Public Property E1EDD54() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54()
            Get
                Return Me.e1EDD54Field
            End Get
            Set
                Me.e1EDD54Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL46

        Private sERNRField As String

        Private uIIField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL46SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL46SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL46SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL57
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL57SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL57SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDL57SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03
        ...
        Private e1IDC03Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03E1IDC03

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1IDC03", Order:=4)>
        Public Property E1IDC03() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03E1IDC03()
            Get
                Return Me.e1IDC03Field
            End Get
            Set
                Me.e1IDC03Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03E1IDC03
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03E1IDC03SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03E1IDC03SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03E1IDC03SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EPC03SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54
        ...
        Private e1EDD55Field() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54E1EDD55

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("E1EDD55", Order:=8)>
        Public Property E1EDD55() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54E1EDD55()
            Get
                Return Me.e1EDD55Field
            End Get
            Set
                Me.e1EDD55Field = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54E1EDD55
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54E1EDD55SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54E1EDD55SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54E1EDD55SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44E1EDD54SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37E1EDL44SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL37SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL54
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL54SEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL54SEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20E1EDL54SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1EDL20SEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1UPSLINK
        ...
        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1UPSLINKSEGMENT
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1UPSLINKSEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1UPSLINKSEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class ZSCMT19C_DELVRY07IDOCE1BP_XI_FORCE

        Private pLVARField As String

        Private oTYPEField As String

        Private oBJ_IDField As String

        Private lOG_SYSTEMField As String

        Private pLANTField As String

        Private sTGE_LOCField As String

        Private sEGMENTField As ZSCMT19C_DELVRY07IDOCE1BP_XI_FORCESEGMENT
        ...
        Public Property OBJ_ID() As String
            Get
                Return Me.oBJ_IDField
            End Get
            Set
                Me.oBJ_IDField = Value
            End Set
        End Property

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public Property LOG_SYSTEM() As String
            Get
                Return Me.lOG_SYSTEMField
            End Get
            Set
                Me.lOG_SYSTEMField = Value
            End Set
        End Property
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()>
        Public Property SEGMENT() As ZSCMT19C_DELVRY07IDOCE1BP_XI_FORCESEGMENT
            Get
                Return Me.sEGMENTField
            End Get
            Set
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCE1BP_XI_FORCESEGMENT
 ...
 System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=True, [Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Public Enum ZSCMT19C_DELVRY07IDOCBEGIN
 ...
 System.Xml.Serialization.XmlTypeAttribute([Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1/types")>
    Partial Public Class SendDeliveryDocumentData

        Private zSCMT19C_DELVRY07Field As ZSCMT19C_DELVRY07

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute(Order:=0)>
        Public Property ZSCMT19C_DELVRY07() As ZSCMT19C_DELVRY07
            Get
                Return Me.zSCMT19C_DELVRY07Field
            End Get
            Set
                Me.zSCMT19C_DELVRY07Field = Value
            End Set
        End Property
    End Class
 ...
 System.ServiceModel.MessageContractAttribute(WrapperName:="sendDeliveryDocument", WrapperNamespace:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
    "ment/v1", IsWrapped:=True)>
    Partial Public Class sendDeliveryDocumentRequest

        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
        "ment/v1/types", Order:=0),
     System.Xml.Serialization.XmlElementAttribute([Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
        "ment/v1/types")>
        Public context As TCContext

        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
        "ment/v1/types", Order:=1),
     System.Xml.Serialization.XmlElementAttribute([Namespace]:="http://services.tint.telekom.net/SupAndPartMgmt/LogWarehouseMgmt/SendDeliveryDocu" &
        "ment/v1/types")>
        Public data As SendDeliveryDocumentData

        Public Sub New()
            MyBase.New
        End Sub

        Public Sub New(ByVal context As TCContext, ByVal data As SendDeliveryDocumentData)
            MyBase.New
            Me.context = context
            Me.data = data
        End Sub
 ...
 System.ServiceModel.MessageContractAttribute(WrapperNamespace:="http://schemas.telekom.net/csdg_v01.02", IsWrapped:=True)>
    Partial Public Class sendDeliveryDocumentResponse
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>
    Public Interface SendDeliveryDocumentConsumerChannel
        Inherits ISendDeliveryDocument, System.ServiceModel.IClientChannel
    End Interface

    <System.Diagnostics.DebuggerStepThroughAttribute(),
 System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>
    Partial Public Class SendDeliveryDocumentConsumerClient
        Inherits System.ServiceModel.ClientBase(Of ISendDeliveryDocument)
        Implements ISendDeliveryDocument
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>
        Function SendDeliveryDocumentConsumer_sendDeliveryDocument(ByVal request As sendDeliveryDocumentRequest) As sendDeliveryDocumentResponse Implements ISendDeliveryDocument.sendDeliveryDocument
            Return MyBase.Channel.sendDeliveryDocument(request)
        End Function

        Public Sub sendDeliveryDocument(ByVal context As TCContext, ByVal data As SendDeliveryDocumentData)
            Dim inValue As sendDeliveryDocumentRequest = New sendDeliveryDocumentRequest()
            inValue.context = context
            inValue.data = data
            Dim retVal As sendDeliveryDocumentResponse = CType(Me, ISendDeliveryDocument).sendDeliveryDocument(inValue)
        End Sub

        '<System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>
        'Function SendDeliveryDocumentConsumer_sendDeliveryDocumentAsync(ByVal request As sendDeliveryDocumentRequest) As System.Threading.Tasks.Task(Of sendDeliveryDocumentResponse) Implements ISendDeliveryDocument.sendDeliveryDocumentAsync
        '    Return MyBase.Channel.sendDeliveryDocumentAsync(request)
        'End Function

        'Public Function sendDeliveryDocumentAsync(ByVal context As TCContext, ByVal data As SendDeliveryDocumentData) As System.Threading.Tasks.Task(Of sendDeliveryDocumentResponse)
        '    Dim inValue As sendDeliveryDocumentRequest = New sendDeliveryDocumentRequest()
        '    inValue.context = context
        '    inValue.data = data
        '    Return CType(Me, ISendDeliveryDocument).sendDeliveryDocumentAsync(inValue)
        'End Function
    End Class
End Namespace