...
Namespace WMSDeliveryManagementService
    ...
    <CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),
     ServiceContractAttribute(Name:="WMSDeliveryManagementService", [Namespace]:="http://logisticsordermanagement.supplypartnermanagement.tmobile.cz/ws/services/wmsdeliverymanagement")>
    Public Interface IWMSDeliveryManagementService
    ...
    Public Interface WMSDeliveryManagementChannel
        Inherits IWMSDeliveryManagementService, System.ServiceModel.IClientChannel
    End Interface

    <System.Diagnostics.DebuggerStepThroughAttribute(),
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>
    Partial Public Class WMSDeliveryManagementClient
        Inherits System.ServiceModel.ClientBase(Of IWMSDeliveryManagementService)
        Implements IWMSDeliveryManagementService
        ...
        Function WMSDeliveryManagement_notifyPackageStatus(ByVal request As notifyPackageStatusRequest) As notifyPackageStatusResponse Implements IWMSDeliveryManagementService.notifyPackageStatus
        ...
        Public Function notifyPackageStatus(ByRef eiMessageContext As EIMessageContext2, ByVal data As WMSDeliveryManagement_notifyPackageStatusRequest) As WMSDeliveryManagement_notifyPackageStatusResponse
            ...
            inValue.data = data
            Dim retVal As notifyPackageStatusResponse = CType(Me, IWMSDeliveryManagementService).notifyPackageStatus(inValue)
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>
        Function WMSDeliveryManagement_receiveCourierLabel(ByVal request As receiveCourierLabelRequest) As receiveCourierLabelResponse Implements IWMSDeliveryManagementService.receiveCourierLabel
        ...
        Public Function receiveCourierLabel(ByRef eiMessageContext As EIMessageContext2, ByVal data As WMSDeliveryManagement_receiveCourierLabelRequest) As WMSDeliveryManagement_receiveCourierLabelResponse
            ...
            inValue.eiMessageContext = eiMessageContext
            inValue.data = data
            Dim retVal As receiveCourierLabelResponse = CType(Me, IWMSDeliveryManagementService).receiveCourierLabel(inValue)
            eiMessageContext = retVal.eiMessageContext
            Return retVal.data
        End Function
